            ...
            {mode === "eml" && (
                <div className="addresslist-box">
                    ...
                    <div className="addedcart-box">
                        ...
                        <p style={{paddingLeft:'10%',fontSize:"1.1rem",paddingBottom:"20px"}}>현재 이메일: {mySessionData.eml||mySessionData.uid}</p>
            ...
            {mode === "phone" && (
                <div className="addresslist-box">
                    ...
                    <div className="addedcart-box">
                        ...
                        <p style={{paddingLeft:'10%',fontSize:"1.1rem",paddingBottom:"20px"}}>현재 전화번호: {mySessionData.phone}</p>
