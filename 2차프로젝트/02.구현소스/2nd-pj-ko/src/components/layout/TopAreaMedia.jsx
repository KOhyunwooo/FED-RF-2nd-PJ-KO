            ...
            {gnbData.map((v, i) => (
              <li key={i}>
                <button
                  ...
                  className={`gnb-button ${selectedIndex === i ? "on" : ""}`}
                  ...
                  {v.txt === "about ZARA" && (
                    <div className="mabout-zara">
                      <p>
                        ...
                        브랜드로 전세계에서 가장 큰 패션 브랜드 중 하나입니다.
                        고객은 디자인, 생산, 유통 및 판매를 모두 총괄하는 Zara의
                        비지니스 모델의 핵심입니다. 더 많은 정보를 원하시면
                        Inditex 그룹의 홈페이지를 참고하시기 바랍니다.
                      ...
                      <img
                        src={
                          ...
                          "/images/about_zara_img/maboutzara001.jpg"
                        }
                        alt="자라이미지"
                      />
                      <p>
                        ZARA에게 JOIN LIFE는 가장 지속 가능한 모델을 향해
                        나아가기 위해 무엇을 해야 하는지 끊임없이 스스로에게
                        질문하고 개선하는 과정을 의미합니다. 우리는 그 길이 쉽지
                        않다는 것을 알고 있지만, 업계의 변화를 이끄는 힘을
                        믿습니다. 이러한 이유로 ZARA의 사회적, 환경적 목표는
                        지속적인 개선을 위해 더욱 까다로워졌습니다.
                      </p>
                      <p>
                        ZARA는 제품 디자인, 소재 선택, 제품 생산, 물류 또는
                        창고와 매장 설계 및 관리에 이르기까지 가치 사슬의 모든
                        단계에서 전체적인 접근 방식으로 작업합니다. 이 모든 것은
                        수선, 재판매 및 더 이상 사용하지 않는 옷 기부 프로그램을
                        통해 의류의 수명을 연장하는 데 도움을 줍니다. 지속
                        가능성에 대한 ZARA의 약속을 달성하는 것은 공급망, 환경
                        전문가, 국제 기구, 노동조합 및 NGO와의 긴밀한 협력이
                        필요한 도전과제입니다. 이 모든 것은 업계의 진정한 변화를
                        이끌기 위한 것입니다. 우리는 완벽하진 않지만, 더 훌륭히
                        해내기 위해 노력을 다하고 있습니다.
                      </p>
                    </div>
                  )}
